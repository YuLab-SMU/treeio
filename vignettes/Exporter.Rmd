...
# Exporting tree data to JSON format
...
exporting tree with data in JSON format, which can be easy to parse using any
...
Such JSON based tree file can be easy to parse using JSON parser.
